...
import com.example.findmytutor.features.tutorDetails.TutorDetailsViewModel
...
class StudentDetailsFragment :  BaseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.distanceFromYou.text = "Distance from you : "+ (Utils.calculateDistanceBetweenStudentTutor(tutor.latitude,tutor.longitude,student.latitude,student.longitude)/1000.0).roundToInt().toString()+" km."
