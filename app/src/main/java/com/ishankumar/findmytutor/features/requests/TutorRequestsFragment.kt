...
import com.ishankumar.findmytutor.databinding.FragmentTutorRequestsBinding
import com.ishankumar.findmytutor.databinding.TutorAcceptStudentRequestDialogBinding
    ...
    override fun onItemClicked(requestTutor: RequestTutor) {
        ...
        {tutor->
            ...
            {student->
               ...
               val distanceValue =(com.ishankumar.findmytutor.utilities.Utils.calculateDistanceBetweenStudentTutor(tutor.latitude,tutor.longitude,student.latitude,student.longitude)/1000.0).roundToInt().toString()+" km."
