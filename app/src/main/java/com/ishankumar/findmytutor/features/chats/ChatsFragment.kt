...
import com.ishankumar.findmytutor.databinding.FragmentChatsBinding
import com.ishankumar.findmytutor.features.MainActivity
import com.ishankumar.findmytutor.utilities.SendNotification
import com.google.firebase.Timestamp
import com.google.firebase.auth.FirebaseAuth
import com.ishankumar.findmytutor.utilities.Encode
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.chattingPageSendButton.setOnClickListener {
            if(binding.chattingPageTextBox.text.isNotEmpty())
            {
                ...
                chattingHelper.lastMessage=Encode.encode(binding.chattingPageTextBox.text.toString())
                ...
                val message=Messages(
                    ...
                    message =Encode.encode(binding.chattingPageTextBox.text.toString()),
                    messageId = chatId,
                    time = Timestamp.now()
                )
